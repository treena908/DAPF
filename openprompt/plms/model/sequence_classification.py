...
# from openprompt.plms.prefix_encoder import PrefixEncoder #for switchprompt
from openprompt.plms.prefixv2_encoder import PrefixEncoder #for ptuning v2
...
class BertPrefixv2ForSequenceClassification(BertPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.num_labels = config.num_labels
        self.config = config
